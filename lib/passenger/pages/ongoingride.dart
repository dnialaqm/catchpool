...
import 'package:catchpool/components/passengercard.dart';
...
class _OngoingRideState extends State<OngoingRide> {
  final OngoingRideController ongoingRideController =
  ...
  void initState() {
    super.initState();
    ongoingRideController.fetchOngoingRideDetailsForCurrentUser();
  }
  ...
  void refreshData() {
    setState(() {
      ...
      ongoingRideController.checkAndSendRideStartedNotification();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            // Trigger a refresh when navigating back
            refreshData();
            Navigator.push(context, MaterialPageRoute(builder: (context) => Navigation()));
          },
        ),
      ),
      body: _buildOngoingRideBody(),
    );
  }

  Widget _buildOngoingRideBody() {
    return SingleChildScrollView(
      child: Obx(() {

        final ride = ongoingRideController.ride.value;
        final driver = ongoingRideController.driver.value;
          ...
          children: [
            ...
            Padding(
              ...
              child: OngoingCard(
                ...
                date: ride.date,
                time: ride.time,
                price: ongoingRideController.calculateTotalPrice(ride.price,ride.pax!).toString(),
                pax: ride.pax ?? "0",
              ),
            ),
            Row(
                ...
                FutureBuilder<Map<String, dynamic>?>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      final driverName = driverData?['fullname'] ?? "No Driver";
